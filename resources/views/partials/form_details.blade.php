         ...
         >
           <v-card-title>
            <img src="{{asset('assets/svg/SVG/medication.svg')}}" class="svg-image" alt="">
             ...
             <span class="titre ml-2 ml-2">Antecedents medicaux</span>
           </v-card-title>
         ...
         >
           <v-card-title>
            <img src="{{asset('assets/svg/SVG/mattress.svg')}}" class="svg-image" alt="">
             ...
             <span class="titre ml-2 ml-2">Antecedents cherirgieaux</span>
           </v-card-title>
          ...
          >
            <v-card-title>
             <img src="{{asset('assets/svg/SVG/nose.svg')}}" class="svg-image" alt="">
              ...
              <span class="titre ml-2 ml-2">Allergie medicamenteuse</span>
            </v-card-title>
