@extends('layouts.layout-admin-sans-infos')
@section('main')
    <div class="container p-5" >
        <div class="patient-header">
            ...
            <button-email patient="{{ $patient}}"></button-email>
            <button
       ...
       <div class="pagination d-block text-center mt-5">
        ...
        @else
            <a href="{{ route('patient.detail',['id'=>$patient->id]) }}" class="btn btn-primary white--text">Voir fichier médical</a>
        @endif
        </div>      
    </div>
@endsection
