...
<head>
    ...
    <style>
        ...
        .main-content > ul > li::before {
          ...
          transform: translate(15px,1px) scale(2);
        }
        .main-content > ul >li { 
            padding: 12px 0;
        }
        ...
        <body>
            ...
            <div class="row text-center" style="font-size: 40px; color: #1b75be">Rapport Medical</div>
            <div class="main">
                <hr>
                ...
                <div class="main-content text-bold">
                    <div>
                        <span style="font-size: 20px" class="blue">Rapport : </span>
                    </div>
                   <div class="rapport">
                       Lorem ipsum dolor, sit amet consectetur adipisicing elit. Qui eligendi consectetur sunt labore id cumque facere! Possimus sapiente minus exercitationem earum. Odio, adipisci non doloremque suscipit impedit ullam excepturi aliquam.
                   </div>
                </div>
                <div class="info-patient" >
                    <span style="font-size: 20px" class="blue">pour : </span>
                    <ul>
